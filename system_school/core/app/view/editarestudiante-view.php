  ...
  <div class="form-group">
    ...
    <div class="form-group col-md-3">
                ...
                <div class="input-group">
                  ...
                  <input type="text" value="<?=$estudiante->fecha_nac;?>" name="fecha_nac" class="form-control">
                </div>
                <!-- /.input group -->
              </div>
 <div class="form-group col-md-3">
  ...
  <button type="button" onclick = "location='./?view=allgrados'" class="btn btn-warning">Cancelar</button>
</div>
</form>
    </section>