...
<div class="row">
	<div class="col-md-12">
		  ...
		  <?php 
            ...
            $goback="./?view=allgrados";
        }else{
            $goback="./?view=prof_grad";
        }
      ?>

		<a href="<?php echo $goback; ?>" class="btn pull-right btn-sm btn-info"><i class='fa fa-arrow-left'></i> Regresar</a>

		<h1>Estudiantes <small><?php echo "del ".$grado->nombre." nivel ".$grado->nivel;?></small></h1>
	
		<?php if($user->kind):?>
			<a href="./?view=nuevoestu&id_grado=<?php echo $_GET["id"]; ?>" class="btn btn-info"><i class='fa fa-asterisk'></i> Nuevo Alumno</a> 
		<?php endif;?>
			...
			?>
				<tr>
					...
					<td style="width:160px;">
						<a href="./?view=abrirestu&id=<?php echo $alumn->id_estudiante;?>&tid=<?php echo $grado->id_grado;?>" class="btn btn-info btn-xs">Ver</a>
						<?php if ($user->kind == 1 || $user->kind == 2): ?>
							<a href="./?view=editarestudiante&id=<?php echo $alumn->id_estudiante;?>&tid=<?php echo $grado->id_grado;?>" class="btn btn-warning btn-xs">Editar</a> 
							<a href="index.php?action=delalumn&id=<?php echo $alumn->id;?>&tid=<?php echo $grado->id;?>" class="btn btn-danger btn-xs">Eliminar</a>
						<?php endif ?>	
					</td>
