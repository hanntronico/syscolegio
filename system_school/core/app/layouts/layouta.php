...
<head>
  ...
  <title>SCJ | Sistema de Gestión Académica</title>
...
<body class="hold-transition 
  <?php if(isset($_SESSION["user_id"])): ?>skin-blue sidebar-mini
  <?php else:?>login-page  
...
<div class="wrapper">
  ...
  <header class="main-header">
   ...
   <a href="./" class="logo">
      ...
      <span class="logo-mini"><b>SCJ</b></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>SYS</b> SCJ</span>
    </a>
...
<?php if($user->kind):?>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019-2020 <a href="http://macberri.pe">MACBERRI</a>.</strong> Todos los derechos
    reservados.
  </footer>
...
<div class="login-box" style="margin-top: 40px;">
  <div class="login-logo">
    <!-- <a href="../../index2.html"><b>SISTEMA ACADEMICO</b>-SCJ</a> -->
    <img class="img-responsive" src="dist/img/Logo_SCJ.png" width="450px">
    <a href="#"><b>SISTEMA ACADEMICO</b></a>
  </div>
  <!-- /.login-logo -->
