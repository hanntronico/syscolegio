...
$destinatario = "iesppvab.info@iesppvab.edu.pe"; 
$asunto = "Mensaje envia desde la web de biblioteca ".$recibe3.""; 
$cuerpo = ' 
<html> 
<head> 
   <title>'.$recibe3.'</title> 
...
<body> 
<p>Estimado administrador de la IESPP "Victor Andres Belaunde" este mensaje es enviado desde el formulario de contacto de la web de la Biblioteca </p>
<p>
...
$headers .= "From: Admin de la biblioteca IESPP <iesppvab.info@iesppvab.edu.pe>\r\n"; 
  ...
  <strong>Alerta!</strong> el mensaje fue enviado, estaremos evaluando su mensaje por el administrador de la web.
                 ...
                 <?php } ?>
                  <div class="section-title text-center">
                    <h2>IESPP "Victor Andres Belaunde" - dispone de esta plataforma ante cualquier duda o consulta que tengas, pronto te estaremos respondiendo a tus preguntas</h2>
                  </div>
