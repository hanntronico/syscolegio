      ...
      <div class="main-panel">
        ...
        <?php if($mensa=="delete"){ ?>
         ...
         <center><img src="images/logo-ini.png"></center><br>
          <div class="row purchace-popup">
            <div class="col-12">
              <h1 align="center">Sistema de Administración Biblioteca</h1>
            </div>
          </div>
                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0"><?=$totahr;?></h3>
                      </div>
                    </div>
                  </div>
                 <p class="text-muted mt-3 mb-0">
                    <a href="libros.php" class="btn btn-primary btn-block"><i class="mdi mdi-format-list-numbers mr-1" aria-hidden="true"></i> Ver detalle aqui..</a>
                  </p>
