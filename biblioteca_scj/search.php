...
<section class="case-studies">
    <div class="container">
       ...
       <div class="section-title text-center">
            <h1>Filtro: <strong><?=$este;?></strong></h1>
        </div>
       <?php }else{ ?>
        <div class="section-title text-center">
            <h1>Filtro: <strong><?=$este;?></strong></h1>
...
while($rwau=$rsauto->fetch_array()){
	...
	<?php
	$sqllib="SELECT l.idl, l.idc, l.titulo, l.tema, l.autor, l.anio, l.edicion, l.lugar, l.editorial, l.cod_isbn, l.detalle, l.canti_ejemplar, l.canti_pagina, l.disponible, l.foto, l.archivo, l.estado, c.categoria, e.nom_edi FROM libro AS l INNER JOIN categoria AS c ON l.idc = c.idc INNER JOIN editorial AS e ON l.editorial = e.idid WHERE l.estado = 'A' AND concat(l.autor,l.titulo,l.detalle,c.categoria,l.cod_isbn) like '%$este%' ";
