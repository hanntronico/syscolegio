        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <input type="date" name="fechanac" class="form-control" required="" id="fechanac" placeholder="Fecha Nacimiento">
            </div>     


            <div class="form-group">
              <label for="lugarnacTwo">Lugar de Nacimiento</label>
              <select name="lug_nacimiento" class="form-control" required="" id="lug_nacimiento">
          ...
          <div class="col-md-6">
            <div class="form-group">
              <label for="lugardomTwo">Lugar de Domicilio</label>
              <select name="lug_domicilio" class="form-control" required="" id="lug_domicilio">
                <option value="1"></option>
              </select>
            </div> 
            ...
            <div class="form-group">
              ...
              <input type="text" name="redes" class="form-control" required="" id="redes" placeholder="Redes Sociales">
            </div>
            
            <div class="form-group">
              <label for="infocontactTwo">Información de Contacto</label>
              <input type="text" name="info" class="form-control" required="" id="info" placeholder="Informacion de contacto">
            </div>
