        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-8">
                <ul class="top-contact pull-right">
                    <li class="phone"><i class="fa fa-phone-square" aria-hidden="true"></i> (076) 431496</li>
                    <li class="email"><i class="fa fa-envelope" aria-hidden="true"></i>iesppvab.info@iesppvab.edu.pe</li>
                    ...
                    <?php if (isset($_SESSION['usuario'])){ ?>
                      ...
                      <li class="get-a-quote"><a href="../logout/" class="text-danger" title="">Cerrar Sesión</a></li>
