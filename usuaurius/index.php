...
<section class="testimonial">
    <div class="container">
      ...
      <p>Busqueda por: DNI, Nombres, Apellido.</p>
       </form>

      <?php if ($lc=='NC'): ?>
        <div style="margin: 0px auto; text-align: center; font-size: 18px; ">
            Ud. aún no ha sido verificado en el sistema, se le enviará un correo cuando se le verifique en la institución, gracias.
        </div>
      <?php endif ?>
