    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
                    ...
                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                      <thead>
                        <tr>
                          ...
                          <th class="th-sm">Carrera <i class="fa fa-sort float-right" aria-hidden="true"></i></th>
        ...
        // idcarrera, carrera, descrip_carrera, nom_corto, estado_carrera                       
        						  ...
        						  $sqlvista="SELECT * FROM carreras WHERE estado_carrera=1 ORDER BY 1 DESC";
